...
if fecha==1:
    ...
    while i==1:
        ...
        print("¿Ha presentado algún color extraño en su fluido vaginal?")
...
if fecha==2:
    ...
    while j==1:
        ...
        print("¿Ha notado algún cambio en el olor de su flujo?")
...
if fecha==4:
    ...
    while h==1:
        ...
        print("¿Ha sentido dolor en la parte inferior de la espalda?")
...
if fecha==7:
    ...
    while so==1:
        ...
        print("¿En los últimos días su piel está amarillenta?")
        ...
        if g==0 or g==1:
            ...
            x=1
            while x==1:
                print("¿¿Consume drogas fuera de las recetadas por su médico??")
