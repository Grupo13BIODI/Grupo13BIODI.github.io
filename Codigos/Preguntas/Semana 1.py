...
if fecha==1:
    ...
    while i==1:
        ...
        print("¿Ha sentido dolor al orinar?")
...
if fecha==4:
    ...
    while h==1:
        ...
        print("¿Ha presentado sangre al miccionar?")
...
if fecha==7:
    ...
    while so==1:
        ...
        if g==0 or g==1:
            ...
            x=1
            while x==1:
                print("¿Ha notado pérdida de peso?")
