...
class Preliminar_f(ttk.Frame):
    def __init__(self,parent,show_menu):
        ...
        Nombre_container = ttk.Frame(self, padding="15 5")
        ...
        Datos_container = ttk.Frame(self,padding="15 5")
        ...
        Semana_container = ttk.Frame(self,padding="15 5")
        ...
        Enc_container = ttk.Frame(self,padding="15 5")
        ...
        lista_frame= ttk.Frame(self,padding="15 5")
        ...
        Boton_container = ttk.Frame(self,padding="15 5")
